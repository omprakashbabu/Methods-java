...
class RandomNumberGenerator extends Thread {
    ...
    @Override
    public void run() {//generates random integer
        try {
...
class SquareThread extends Thread {//if the number is even squares the number 
    private int number;
...
class CubeThread extends Thread {//if number is odd cubes the number
    private int number;
